...
<a class="navbar-brand" href="index.html">Garima Bisht </a>
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   ...
   <li class="nav-item nav-item-hover"><a class="nav-link" href="https://drive.google.com/file/d/1bsy84TxDt2PK9wpQWqeRMwBKOUa9LbhU/view?usp=sharing" target="_blank">Resume</a></li>
   <li class="nav-item">
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    <div class="container-fluid quote-container">
      ...
      <p class="tag" >Imagination is more important than knowledge. Knowledge is limited. Imagination encircles the world.</p>
    </div>
...
--!>
    ...
    <a class="social-button linkedin" href="https://www.linkedin.com/in/garima-bisht-7b784014b/" target="_blank" >
    ...
    <a class="social-button instagram" href="https://instagram.com/_gracy_galaxy_" target="_blank" >
    ...
    <a class="social-button github" href="https://github.com/GariBisht" target="_blank">
